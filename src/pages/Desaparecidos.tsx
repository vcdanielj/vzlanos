...
// Tablero público de personas desaparecidas/encontradas, pensado para reunificar:
// cada tarjeta trae foto, datos, y acciones (contactar familia, pista, compartir).
			...
			<div className="flex items-start justify-between gap-2">
				<div>
					...
					<p className="text-sm text-muted-foreground">
						Si reconoces a alguien, deja una pista o contacta a su familia.
					</p>
				</div>
